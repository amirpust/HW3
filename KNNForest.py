...
def choose_params(N, train_data, feats, probability, K):
...
# best = choose_params(N, data_diag, features, P, K)
# print("k = " + str(best[1]) + " N = " + str(best[2]) + " P = " + str(best[3]))

N = 20
K = 0.7
P = 0.7
knn = KNN(N=N, K=int(np.ceil(N * K)), P=P)
